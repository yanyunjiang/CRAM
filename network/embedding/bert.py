...
class BERTEmbedding(nn.Module):
    ...
    def __init__(self, embed_size, dropout=0.1, mini_batch_size=2, sample_num=3):
        """
    ...
    def forward(self, sequence, segment_label):
        ...
        # print("sequence", sequence.shape, "pos_embedding", pos_embedding.shape, "seg_embedding", seg_embedding.shape)
