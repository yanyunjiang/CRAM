...
if __name__ == '__main__':
    ...
    img_name = "436219-35356-55497-[1, 1, 0].png"
    img_list = [Image.open(voc12.data.get_img_path(img_name, args.voc12_root)).convert("RGB")]
    label = torch.from_numpy(np.array([1., 1., 0.]))
    
    print("img_name: ", img_name)
    print("label:", label)

    # if img_name != "436219-35356-55497-[1, 1, 0].png":
    #     continue
    # else:
    ...
    if args.out_cam_pred is not None:
        ...
        imageio.imwrite(os.path.join(args.out_cam_pred, img_name), pred.astype(np.uint8))
    ...
    if args.out_crf_pred is not None:
        ...
        imageio.imwrite(os.path.join(args.out_crf_pred, img_name), pred.astype(np.uint8))